...
export const STORE_NUMBER_PERMISSION_ID = ethers.utils.id("STORE_NUMBER_PERMISSION");
export const STORE_ACCOUNT_PERMISSION_ID = ethers.utils.id("STORE_ACCOUNT_PERMISSION");
